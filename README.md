...
<details>
  ...
  * 결과
    ...
    |항목|개선 전|개선 후|감소 시간|개선율| 
    |:-|:-|:-|:-|:-|
    |전체 챌린지 조회|477ms|103ms|374ms|363.1%| 
    |카테고리 검색|300ms|59ms|241ms|408.5%|
    |검색|345ms|97ms|248ms|255.7%|
    |인증 게시글 상세 조회|220ms|149ms|71ms|47.7%|
    |인증 게시글 전체 조회|261ms|176ms|85ms|48.3%|
    |챌린지 상세 조회|196ms|74ms|122ms|164.9%|
    |레포트 조회|241ms|241ms|0ms|0%|
    |행성 추천|782ms|567ms|215ms|37.9%|
    |채팅 메시지 조회|211ms|194ms|17ms|8.8%|
    |채팅방 목록 조회|521ms|385ms|136ms|35.3%|
    |마이페이지 챌린지 조회|520ms|251ms|269ms|107.2%|
