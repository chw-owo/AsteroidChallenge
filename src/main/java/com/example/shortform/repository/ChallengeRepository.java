...
public interface ChallengeRepository extends JpaRepository<Challenge, Long> {
    ...
    @Query(value = "select distinct c from Challenge c " +
            ...
            "left join c.tagChallenges t " +
            "left join c.challengeImage i " +
            "where c.title like %:keyword% or c.category.name like %:keyword% or t.tag.name like %:keyword%",
